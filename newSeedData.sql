...
VALUES 
  (1, 'ZapG8Pk4rwN8yQMNXhHTsASNM2t2', 'Billy Williamson', 'billy@billy.com', null, null, '08-06-2020');
INSERT INTO [UserProfile]
  ([Id], [FirebaseUserId], [Name], [Email], [ImageUrl], [Bio], [DateCreated])
VALUES 
  (2, 'DScVgYFGoPTJREdxyS9utzYK2VZ2', 'Bob Robertson', 'bob@bob.com', null, null, '08-06-2020');
